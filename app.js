...
const culturalUnits = [
  { id: "pedalangan", name: "Pedalangan", img: "pentas-wayang-kulit.jpg", desc: "Pelatihan seni pewayangan komprehensif, meliputi teknik memegang wayang (sabetan), intonasi suara (catur/suluk), dan filsafat lakon carangan Jawa.", members: "45 Cantrik", schedule: "Sabtu, 15.00 - 18.00 WIB", instructor: "Paryatno", achievements: "Juara 1 Dalang Bocah Jawa Timur 2024" },
  { id: "rumahadat", name: "Rumah Adat", img: "unit-rumahadat.jpg", desc: "Pelestarian dan edukasi arsitektur tradisional Joglo Sinom Watulimo yang dibangun tanpa menggunakan paku besi, memamerkan kearifan sipil kuno.", members: "Umum", schedule: "Setiap Hari, 08.00 - 16.00 WIB", instructor: "Sutarman", achievements: "Cagar Budaya Tersertifikasi Provinsi" },
  { id: "perpustakaan", name: "Perpustakaan Budaya", img: "unit-perpustakaan.jpg", desc: "Ruang baca khusus koleksi naskah rontal, babad kuno, kamus Jawa-Kuno, serta dokumentasi visual upacara adat Trenggalek.", members: "120+ Anggota", schedule: "Selasa - Minggu, 09.00 - 15.00 WIB", instructor: "Ayu Lucky Setiani", achievements: "Arsip Digital Terlengkap se-Trenggalek" },
  { id: "jaranan", name: "Jaranan Turonggo Yakso", img: "unit-jaranan.jpg", desc: "Seni tari khas Trenggalek yang melambangkan kemenangann kesadaran spiritual manusia atas nafsu angkara murka raksasa (Yakso).", members: "150 Penari", schedule: "Minggu, 09.00 - 12.00 WIB", instructor: "Bambang Sudewo, S.Pd", achievements: "Penyaji Terbaik Festival Jaranan Nasional" },
  { id: "campursari", name: "Campursari", img: "unit-campursari.jpg", desc: "Harmonisasi instrumen musik barat modern (keyboard, gitar) dengan gamelan Jawa tradisional, melestarikan musik pop daerah Jawa.", members: "40 Musisi", schedule: "Kamis, 19.30 - 22.00 WIB", instructor: "Sofan Hadi", achievements: "Album Kompilasi Karya Sanggar RBW 2023" },
  { id: "karawitan", name: "Karawitan & Gamelan", img: "unit-karawitan.jpg", desc: "Pendidikan instrumen gamelan perunggu (Saron, Bonang, Demung, Gong) dalam tangga nada Laras Slendro dan Pelog.", members: "85 Siswa", schedule: "Sabtu, 13.00 - 15.30 WIB", instructor: "Budi Karyanto", achievements: "Pengisi Musik Utama Ritual Sembonyo" },
  { id: "tari", name: "Seni Tari Pesisir", img: "unit-tari.jpg", desc: "Pelatihan tari kreasi daerah yang terinspirasi dari aktivitas kehidupan nelayan Prigi dan dinamika laut selatan Jawa.", members: "90 Siswa", schedule: "Jumat, 15.00 - 17.00 WIB", instructor: "Roro Riwayatiningsih, S.Pd", achievements: "Koreografi Unggulan Parade Seni Jatim" },
  { id: "beksan", name: "Beksan Klasik Jawa", img: "unit-beksan.jpg", desc: "Pengajaran tari gaya klasik Keraton Surakarta dan Yogyakarta (Gatotkaca Gandrung, Srikandi Mustakaweni) demi etika gerak halus.", members: "30 Siswa", schedule: "Rabu, 15.30 - 17.30 WIB", instructor: "Roro Riwayatiningsih, S.Pd", achievements: "Penyaji Tari Klasik Terbaik Trenggalek" },
  { id: "modelling", name: "Modelling Etnik", img: "unit-modelling.jpg", desc: "Pelatihan koreografi catwalk dengan mengenakan kostum kreasi tradisional berbasis batik tulis Watulimohan.", members: "35 Siswa", schedule: "Jumat, 19.00 - 21.00 WIB", instructor: "Agung Baskoro", achievements: "Juara Harapan Fashion Carnaval Nasional" },
  { id: "bahasajawa", name: "Pelatihan Bahasa Jawa", img: "unit-bahasajawa.jpg", desc: "Pengajaran tata krama berbahasa (Ngoko, Madya, Krama Inggil) dan penulisan aksara Jawa demi menjaga unggah-ungguh sosial.", members: "75 Siswa", schedule: "Selasa, 15.30 - 17.00 WIB", instructor: "Suharyono", achievements: "Juara Umum Lomba Menulis Aksara Jawa" }
];
...
function initAchievements() {
  ...
  achievementsData.forEach(aw => {
    ...
    const imgHtml = aw.img
      ? `<div class="award-row-card__img-wrap"><img class="award-row-card__img" src="${aw.img}" alt="${aw.title}" loading="lazy"></div>`
      : "";
    card.innerHTML = `
      ${imgHtml}
